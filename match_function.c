 ...
 *and returns the corresponding function that matches
 *@line: struct containing line contents and line number of the function
 *@meta: struct containing all the allocated memory
 *Return: pointer to the matching functions
 */
